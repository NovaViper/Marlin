...
#define STRING_CONFIG_H_AUTHOR "(NovaViper, Xavier)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Xavier"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "66c527ec-44bc-47cd-87d6-b1ce2bcda6d8"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-3
    ...
    #define DEFAULT_Kp_LIST {  15.45,  15.45 }
    #define DEFAULT_Ki_LIST {   0.92,   0.92 }
    #define DEFAULT_Kd_LIST {  64.60,  64.60 }
  #else
    #define DEFAULT_Kp  15.45
    #define DEFAULT_Ki   0.92
    #define DEFAULT_Kd  64.60
  #endif
#endif // PIDTEMP
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 423.47 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 45.8, 14.2, -4.320 }
