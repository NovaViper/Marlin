...
#define STRING_CONFIG_H_AUTHOR "(NovaViper, Chimera)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Chimera"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "834fd0bc-a10d-44be-9abb-9564cca90b7f"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  15.59,  15.59 }
    #define DEFAULT_Ki_LIST {   0.96,   0.96 }
    #define DEFAULT_Kd_LIST {  63.60,  63.60 }
  #else
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //Old Prusa PCB Bed + 8mm plain glass+Overture sheet
  #define DEFAULT_bedKp 208.01
  #define DEFAULT_bedKi 37.96
  #define DEFAULT_bedKd 759.95
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 4000, 423.47 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 40, 0, -1.00 }
